...
**Update 2026-09-03:** #31 (clean-corpus ablation) is closed. A separately
versioned ablation protocol, downstream of the frozen Attempt-1 manifest, ran
one real seed-42 three-epoch clean-only corpus (0 prompt-injection / 3,500
clean-control / 1,000 ambiguous-boundary / 500 refusal-calibration) and only
the six published visible benchmarks. It passed the required deliberate
mid-epoch termination and exact-command resume test, completing in 11.88
separate GPU-hours. The capability collapse persisted without prompt-injection
rows: epoch-3 GSM8K was 0.490 versus baseline 0.735 and IFEval 0.430 versus
0.615, while MMLU improved to 0.613. The OPI improvement shrank markedly
(0.400 versus 0.180 baseline; Attempt-1 seed-42 epoch 3 was 0.667). Thus the
explicit prompt-injection category alone is not a sufficient explanation for
the capability failure. The run is ablation-only: no held-out data, selection,
